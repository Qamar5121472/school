        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 course d-lg-flex ftco-animate">
                    <div class="img" style="background-image: url('{{ asset('frontEndAssets/images/course-1.jpg') }}')">
                    </div>
                ...
                <div class="col-md-6 course d-lg-flex ftco-animate">
                    <div class="img" style="background-image: url('{{ asset('frontEndAssets/images/course-2.jpg') }}')">
                    </div>
                    <div class="text bg-light p-4">
                ...
                <div class="col-md-6 course d-lg-flex ftco-animate">
                    <div class="img" style="background-image: url('{{ asset('frontEndAssets/images/course-3.jpg') }}')">
                    </div>
                    <div class="text bg-light p-4">
                ...
                <div class="col-md-6 course d-lg-flex ftco-animate">
                    <div class="img" style="background-image: url('{{ asset('frontEndAssets/images/course-4.jpg') }}')">
                    </div>
                    <div class="text bg-light p-4">
                ...
                <div class="col-md-6 course d-lg-flex ftco-animate">
                    <div class="img" style="background-image: url('{{ asset('frontEndAssets/images/course-5.jpg') }}')">
                    </div>
                    <div class="text bg-light p-4">
                ...
                <div class="col-md-6 course d-lg-flex ftco-animate">
                    <div class="img" style="background-image: url('{{ asset('frontEndAssets/images/course-6.jpg') }}')">
                    </div>
                    <div class="text bg-light p-4">
