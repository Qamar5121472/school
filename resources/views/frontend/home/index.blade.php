...
@section('content')
    ...
    <section class="ftco-intro" style="background-image: url('{{ asset('frontEndAssets/images/bg_3.jpg') }}')"
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="staff">
                        <div class="img-wrap d-flex align-items-stretch">
                            <div class="img align-self-stretch"
                                style="background-image: url('{{ asset('frontEndAssets/images/teacher-3.jpg') }}')">
                            </div>
                        </div>
                        <div class="text pt-3 text-center">
                            <h3>Stella Smith</h3>
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="staff">
                        <div class="img-wrap d-flex align-items-stretch">
                            <div class="img align-self-stretch"
                                style="background-image: url('{{ asset('frontEndAssets/images/teacher-4.jpg') }}')">
                            </div>
                        </div>
                        <div class="text pt-3 text-center">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 course d-lg-flex ftco-animate">
                    <div class="img"
                        style="background-image: url('{{ asset('frontEndAssets/images/course-1.jpg') }}')"></div>
                ...
                <div class="col-md-6 course d-lg-flex ftco-animate">
                    <div class="img"
                        style="background-image: url('{{ asset('frontEndAssets/images/course-2.jpg') }}')"></div>
                    <div class="text bg-light p-4">
                ...
                <div class="col-md-6 course d-lg-flex ftco-animate">
                    <div class="img"
                        style="background-image: url('{{ asset('frontEndAssets/images/course-3.jpg') }}')"></div>
                    <div class="text bg-light p-4">
                ...
                <div class="col-md-6 course d-lg-flex ftco-animate">
                    <div class="img"
                        style="background-image: url('{{ asset('frontEndAssets/images/course-4.jpg') }}')"></div>
                    <div class="text bg-light p-4">
    ...
    <section class="ftco-section ftco-counter img" id="section-counter"
        style="background-image: url('{{ asset('frontEndAssets/images/bg_4.jpg') }}')"
        data-stellar-background-ratio="0.5">
        <div class="container">
            <div class="row justify-content-center mb-5 pb-2">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="pricing-entry bg-light active pb-4 text-center">
                        ...
                        <div class="img"
                            style="background-image: url('{{ asset('frontEndAssets/images/bg_3.jpg') }}')">
                        </div>
                        <div class="px-4">
                            <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia,
                                there live the blind texts.</p>
                ...
                <div class="col-md-6 col-lg-4 ftco-animate">
                    <div class="blog-entry">
                        <a href="blog-single.html" class="block-20 d-flex align-items-end"
                            style="background-image: url('{{ asset('frontEndAssets/images/image_1.jpg') }}')">
